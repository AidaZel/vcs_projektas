...
<body>
  ...
  <div class="container">
    ...
    <h1 class="center-align indigo-text text-lighten-1">Monterosso al Mare, Italy</h1>
    ...
    <div class="row">
      <div class="col s6">
        ...
        <a href="accomodation_italy.php" class="btn waves-effect">Search</a>
      ...
      <div class="col s6">
        <div class="weather">
          <h3></h3>
          <a class="weatherwidget-io" href="https://forecast7.com/en/44d159d65/monterosso-al-mare/" data-label_1="MONTEROSSO AL MARE" data-theme="weather_one">MONTEROSSO AL MARE</a>
          <script>
            ! function(d, s, id) {
      ...
      <div class="col s6">
        <div class="card">
          <div class="card-image">
            <img src="pictures/italy-2.jpg">
            <span class="card-title">About Monterosso al Mare, Italy</span>
          </div>
    ...
    <div class="multiple-items">
      <div><img src="pictures/italy-1.jpg"></div>
      <div><img src="pictures/italy-2.jpg"></div>
      <div><img src="pictures/italy-3.jpg"></div>
      <div><img src="pictures/italy-4.jpg"></div>
      <div><img src="pictures/italy-5.jpg"></div>
    </div>
