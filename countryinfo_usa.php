...
<body>
  ...
  <div class="container">
    ...
    <h1 class="center-align indigo-text text-lighten-1">Los Angeles, USA</h1>
    ...
    <div class="row">
      <div class="col s6">
        ...
        <a href="accomodation_usa.php" class="btn waves-effect">Search</a>
      </div>

      <div class="col s6">
        <div class="weather">
          <h3></h3>
          <a class="weatherwidget-io" href="https://forecast7.com/en/34d05n118d24/los-angeles/" data-label_1="LOS ANGELES" data-theme="weather_one">LOS ANGELES</a>
          <script>
            ! function(d, s, id) {
      ...
      <div class="col s6">
        <div class="card">
          <div class="card-image">
            ...
            <span class="card-title">About Los Angeles, USA</span>
          </div>
    ...
    <div class="multiple-items">
      <div><img src="pictures/usa-1.jpg"></div>
      <div><img src="pictures/usa-2.jpg"></div>
      <div><img src="pictures/usa-3.jpg"></div>
      <div><img src="pictures/usa-5.jpg"></div>
      <div><img src="pictures/usa-4.jpg"></div>
    </div>
