...
<body>
  ...
  <div class="container">
    ...
    <h1 class="center-align indigo-text text-lighten-1">Reykjavík, Iceland</h1>
    ...
    <div class="row">
      <div class="col s6">
        ...
        <a href="accomodation_iceland.php" class="btn waves-effect">Search</a>
        <!-- Monterosso al Mare, Italy
    Port of Spain, Trinidad and Tobago
    Los Angeles, USA -->
      ...
      <div class="col s6">
        <div class="card">
          <div class="card-image">
            ...
            <span class="card-title">About Reykjavík, Iceland</span>
            <!-- Monterosso al Mare, Italy
            Port of Spain, Trinidad and Tobago
            Los Angeles, USA -->
          </div>
  ...
  <div class="row container">
    ...
    <div class="row">
      ...
      <div class="col s6">
        ...
        <div class="card horizontal">
          <div class="card-image">
            <img src="pictures/iceland-2.jpg">
          </div>
          <div class="card-stacked">
            <div class="card-content">
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat a, ullam, repellendus.</p>
