...
<body>
  ...
  <div class="parallax-container">
    ...
    <div class="parallax">
      <img src="pictures/trinidad-7.jpg" alt="" class="responsive img"></div>
  </div>
    ...
    <div class="row container">
      ...
      <div class="row">
        ...
        <div class="col s6">
          <div class="card horizontal">
            <div class="card-image">
              <img src="pictures/trinidad-8.jpg">
            </div>
        ...
        <div class="col s6">
          ...
          <div class="card horizontal">
            <div class="card-image">
              <img src="pictures/trinidad-9.jpg">
            </div>
            <div class="card-stacked">
              <div class="card-content">
                <h3>109,- Eur</h3>
  ...
  <div class="parallax-container">
    <div class="parallax">
      <img src="pictures/trinidad-6.jpg" alt="" class="responsive img"></div>
  </div>
    ...
    <div class="row container">
      ...
      <div class="row">
        ...
        <div class="col s12">
          <div class="card horizontal">
            <div class="card-image">
              <img src="pictures/trinidad-1.jpg">
            </div>
            <div class="card-stacked">
              <div class="card-content">
